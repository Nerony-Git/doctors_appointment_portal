      ...
      <div class="breadcrumbs">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> Assigned History</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="card register_card">
        <div class="card-body">
          <p class="fw-bold text-center text-primary fs-4"> Assigned Appointments History</p>
          ...
          <table class="table table-striped table-hover">
            ...
            <c:forEach var="appointment" items="${appointmentList}">
              <tr>
                ...
                <td><a href="appointments?id=<c:out value="${appointment.appointmentID}"/>" class="btn btn-sm btn-primary"><i class="fa-solid fa-eye"></i>&nbsp; View</a> </td>
              </tr>
            </c:forEach>
