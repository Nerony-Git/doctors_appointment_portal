...
<head>
    ...
    <title>DPA Portal - Doctor Register</title>
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card register_card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form action="<%=request.getContextPath()%>/new_doctor" method="post">
                            ...
                            <!-- End Form -->
                            <br/>
                            <p>Already have an account? <a href="<%=request.getContextPath()%>/doctor_login" class="text-decoration-none">Login</a></p>
                        </div>
                    </div>
                </div>
            </div>
