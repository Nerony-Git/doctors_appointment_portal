...
<head>
    ...
    <title>DPA Portal - View Doctor Details </title>
            ...
            <div class="breadcrumbs">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> View Doctor Details </li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card register_card">
                    <div class="card-header text-center text-white bg_color">
                        <p class="fs-4 text-center text-white mt-2">
                            <i class="fa-solid fa-user-pen"></i> &nbsp; View Doctor Profile
                        </p>
                    </div>
                    <div class="card-body">
                        <!-- Success Message -->
