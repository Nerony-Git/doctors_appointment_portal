...
<head>
    ...
    <title>DPA Portal - View Appointment </title>
            ...
            <div class="breadcrumbs">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/view_appointments">Appointment History List</a></li>
            ...
            <div class="card register_card">
                <div class="card-header text-center text-white bg_color">
                    <p class="fs-4 text-center text-white mt-2">
                        <i class="fa-solid fa-calendar-week"></i> &nbsp; Appointment Details
                    </p>
                </div>
