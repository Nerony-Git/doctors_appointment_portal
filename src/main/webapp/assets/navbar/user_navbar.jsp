...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li class="dropdown" id="user"><a href="#"><i class="fa-solid fa-circle-user fa-2x"></i> <span> &nbsp; ${user.firstName} ${user.lastName} </span> <i class="bi bi-chevron-down"></i> </a>
                    <ul>
                        <li><a class="nav-link" href="<%=request.getContextPath()%>/user_view"><i class="fa-solid fa-id-card"></i> &nbsp; View Profile </a> </li>
